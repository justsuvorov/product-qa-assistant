...
class Settings(BaseSettings):
    ...
    ai_role: str = Field(
        default=(
            ...
            "Если информации недостоточно для однозначного ответа — можешь задать уточняющий вопрос пользователю."
            ...
            "У тебя нет доступа к информации о полисах, выплатах, премиях и любой конфиденциальной и персональной информации."
        ),
        alias="AI_ROLE"
    )
