...
class BaseProductMapper(ABC):
    """Базовый интерфейс для нормализации пользовательских запросов."""

    @abstractmethod
    def normalize(self, text: str) -> str:
        """Заменяет алиасы/аббревиатуры на официальные названия продуктов."""

    @abstractmethod
    def reload(self) -> None:
        """Перезагружает словарь алиасов без перезапуска приложения."""


# ==============================================================================
# Реализация на основе JSON-файла
# ==============================================================================
